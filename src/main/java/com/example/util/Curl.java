...
//				logger.info("[Curl] post() Exception");
				Mail.mailSend();
	...
	public static String connPost(String strUrl, String[] headers, String data)   {
		...
		if ( strUrl == null ) {
//			logger.info("[Curl] connPost() strUrl-NULL");
//			System.out.println("strUrl NULL");
			//URL n
			Mail.mailSend();
			throw new NullPointerException("url is null");
		}
...
//				logger.info("[Curl] connPost() Exception");
				Mail.mailSend();
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			logger.info("[Post] R/esponse::: " + ret);
			
		} catch (ProtocolException e) {
//			logger.info("[Curl] connPost() ProtocolException");
			Mail.mailSend();
			e.printStackTrace();
			
		} catch (IOException e) {
//			logger.info("[Curl] connPost() IOException");
			Mail.mailSend();
			e.printStackTrace();
